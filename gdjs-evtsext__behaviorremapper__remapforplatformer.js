...
gdjs.evtsExt__BehaviorRemapper__RemapForPlatformer.RemapForPlatformer = class RemapForPlatformer extends gdjs.RuntimeBehavior {
  ...
  applyBehaviorOverriding(behaviorOverriding) {
    ...
    if (behaviorOverriding.Platformer !== undefined)
      this._behaviorData.Platformer = behaviorOverriding.Platformer;
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = eventsFunctionContext.getOnceTriggers().triggerOnce(10875828);
}
if (isConditionTrue_0) {
